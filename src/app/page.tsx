            ...
            <div className="max-w-3xl flex flex-col items-center text-center">
                ...
                <div className="text-sm md:text-lg text-slate-500">
                    <Typewriter
                        ...
                        onInit={(typewriter) => {
                            typewriter.typeString('🚀 Enhance your tutoring workflow')
                                .pauseFor(2500)
                                .deleteAll()
                                .typeString('📆 Schedule classes and lessons conveniently')
                                .pauseFor(2500)
                                .deleteAll()
                                .typeString('📚 Store homework and lessons in private knowledge base')
                                .pauseFor(2500)
                                .deleteAll()
                ...
                <Button className="w-48 md:w-64 mt-6 md:mt-8 py-4 md:py-6 bg-green-700 hover:bg-green-600"
                        onClick={() => router.push("/auth/login")}>Get Started</Button>
            </div>
